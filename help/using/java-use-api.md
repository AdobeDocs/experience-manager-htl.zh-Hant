...
新增此元件的一些內容，以便在 `/content/my-example/` 中呈現：
...
如需詳細資訊，請參閱`Sling` [HTL Scripting Engine檔案](https://sling.apache.org/documentation/bundles/scripting/scripting-htl.html#passing-parameters-to-java-use-objects)。
